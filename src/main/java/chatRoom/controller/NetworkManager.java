...
public class NetworkManager {
	 ...
	 *            ClientViewController communicating with this manager
	 * @param blockingQueue
	 *            BlockingQueue storing events from the view. Events are read in
	...
	public NetworkManager(ClientViewController viewController, BlockingQueue<BaseEvent> blockingQueue) {
		...
		eventToStrategyMap = new HashMap<Class<? extends BaseEvent>, NetworkStrategy>();
	 ...
	 * 
	 * @param event
	 *            BaseEvent to be send to the server
	 */
	 ...
	 * 
	 * @param state
	 *            newly received ChatState object
	 */
	 ...
	 * 
	 * @param messages
	 *            list of ChatMessages to be searched

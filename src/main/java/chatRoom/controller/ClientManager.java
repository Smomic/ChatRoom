...
public class ClientManager extends Thread {
	 ...
	 * 
	 * @param socket
	 *            socket to which this client is going to connect
	 * @param blockingQueue
	 *            queue to which this client manager is going to send events
	 * @throws IOException
	 *             if could not create ObjectStream
	 */
	public ClientManager(Socket socket, BlockingQueue<BaseEvent> blockingQueue) throws IOException {
		this.socket = socket;
	...
	public void close() {
		stopFlag = false;
		loginFlag = false;
		// catching exceptions in ServerManager
		try {

 ...
 * is also responsible for creating NetwordManager
 * 
 * @author Michal
 */
public class ClientViewController {
	 ...
	 * 
	 * @param isConnected
	 *            true if view should be displayed for connected user
	 */
	...
	private void clearUserNames() {
		if (!usernameListView.getItems().isEmpty())
